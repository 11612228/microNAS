...
def get_train():
    ...
    data1 = load('data/cifar-10-batches-py/data_batch_1')
    x1 = np.array(data1[b'data'])
    x1 = x1.reshape(-1, 32, 32, 3)
    y1 = np.array(data1[b'labels'])

    data2 = load('data/cifar-10-batches-py/data_batch_2')
    ...
    data3 = load('data/cifar-10-batches-py/data_batch_3')
    ...
    data4 = load('data/cifar-10-batches-py/data_batch_4')
    ...
    # data5 = load('data/cifar-10-batches-py/data_batch_5')
    # x5 = np.array(data4[b'data'])
    # x5 = x5.reshape(-1, 32, 32, 3)
    # y5 = data5[b'labels']
...
def get_test():
    data = load('data/cifar-10-batches-py/test_batch')
